...
function getSupabaseStorageUrl($bucket, $fileName) {
    ...
    $storageUrl = "https://nprybujuvlzhiyybcmcv.supabase.co/storage/v1/object/public/{$bucket}/{$fileName}";
...
function renderContactSubmissions($pdo) {
    ...
    if (count($contacts) === 0) {
        ...
        foreach ($contacts as $contact) {
            ...
            echo '<td>
                    <button class="btn btn-sm btn-primary view-contact" data-id="' . $contact['id'] . '">View</button>
                    <div class="dropdown d-inline">
                        <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="statusDropdown' . $contact['id'] . '" data-bs-toggle="dropdown">
                            Update
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="statusDropdown' . $contact['id'] . '">
                            <li><a class="dropdown-item update-status" data-id="' . $contact['id'] . '" data-status="new" href="#">Mark as New</a></li>
                            <li><a class="dropdown-item update-status" data-id="' . $contact['id'] . '" data-status="in-progress" href="#">Mark as In Progress</a></li>
                            <li><a class="dropdown-item update-status" data-id="' . $contact['id'] . '" data-status="completed" href="#">Mark as Completed</a></li>
                        </ul>
                    </div>
                  </td>';
            echo '</tr>';
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .resume-modal-iframe iframe[src*=".pdf"] {
            width: 100%;
            max-width: 80%;
                                ...
                                <?php foreach ($applications as $application): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-primary view-resume-modal"
                                                       data-id="<?php echo $application['id']; ?>">
                                                    <i class="bx bx-show"></i>
                                                </button>
